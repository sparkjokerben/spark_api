...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PaymentBalanceRechargeExpression:                       paymentCfg.BalanceRechargeExpression,
		PaymentSubscriptionRechargeExpression:                  paymentCfg.SubscriptionRechargeExpression,
		PaymentFXRateFallback:                                  paymentCfg.FXRateFallback,
		...
		PaymentBalanceRechargeHelpText:                         paymentCfg.BalanceRechargeHelpText,
		PaymentSubscriptionShowRate:                            paymentCfg.SubscriptionShowRate,
		PaymentSubscriptionShowPeakRate:                        paymentCfg.SubscriptionShowPeakRate,
		PaymentSubscriptionShow5hLimit:                         paymentCfg.SubscriptionShow5hLimit,
		PaymentSubscriptionShowWeekLimit:                       paymentCfg.SubscriptionShowWeekLimit,
		PaymentSubscriptionShowTotalLimit:                      paymentCfg.SubscriptionShowTotalLimit,
		PaymentSubscriptionShowModelScopes:                     paymentCfg.SubscriptionShowModelScopes,
