...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	effectiveSticky, stickySource := k.EffectiveQuotaSticky()
	out := &APIKey{
		ID:                   k.ID,
		UserID:               k.UserID,
		Key:                  k.Key,
		...
		QuotaStickyMode:      k.QuotaStickyMode,
		QuotaStickyEffective: effectiveSticky,
		QuotaStickySource:    stickySource,
...
func APIKeyFromServiceAdmin(k *service.APIKey) *AdminAPIKey {
	...
	return &AdminAPIKey{
		...
		Group:  GroupFromServiceAdmin(k.Group),
	}
}
