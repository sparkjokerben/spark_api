...
func (r *groupRepository) Create(ctx context.Context, groupIn *service.Group) error {
	builder := r.client.Group.Create().
		...
		SetQuotaStickyDefaultEnabled(groupIn.QuotaStickyDefaultEnabled).
		SetQuotaStickyUserOverrideAllowed(groupIn.QuotaStickyUserOverrideAllowed).
		SetSessionModelStabilityEnabled(groupIn.SessionModelStabilityEnabled).
		SetUnifiedRetryBudgetEnabled(groupIn.UnifiedRetryBudgetEnabled)
