...
export interface SystemSettings {
  ...
  payment_balance_recharge_expression: string;
  payment_subscription_recharge_expression: string;
  payment_fx_rate_fallback: number;
  ...
  payment_balance_recharge_help_text: string;
  payment_subscription_show_rate: boolean;
  payment_subscription_show_peak_rate: boolean;
  payment_subscription_show_5h_limit: boolean;
  payment_subscription_show_week_limit: boolean;
  payment_subscription_show_total_limit: boolean;
  payment_subscription_show_model_scopes: boolean;
