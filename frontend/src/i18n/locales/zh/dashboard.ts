export default {
  ...
  keys: {
	...
	quotaStickyMode: '额度优先粘性调度',
	quotaStickyInherit: '继承分组默认值',
	quotaStickyEnabled: '开启',
	quotaStickyDisabled: '关闭',
	quotaStickyHint: '尽可能让同一会话保持在原账号，以提高缓存复用。',
	quotaStickyLocked: '该分组不允许 API Key 覆盖此设置。',
