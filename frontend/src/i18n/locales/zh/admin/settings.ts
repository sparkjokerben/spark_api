export default {
    settings: {
      ...
      payment: {
        ...
        balanceRechargeExpression: '余额到账倍率表达式',
        subscriptionRechargeExpression: '订阅支付倍率表达式',
        rechargeExpressionHint: '支持数值、括号和四则运算；%fx_rate% 表示实时 USD/CNY 汇率',
        fxRateFallback: '汇率失败回退值',
        fxRateFallbackHint: '实时汇率获取失败时替代 %fx_rate% 的值',
        subscriptionDisplay: '用户侧套餐信息展示',
        subscriptionShowRate: '基础倍率',
        subscriptionShowPeakRate: '高峰倍率',
        subscriptionShow5hLimit: '5 小时限额',
        subscriptionShowWeekLimit: '周限额',
        subscriptionShowTotalLimit: '月限额',
        subscriptionShowModelScopes: '支持模型',
        balanceRechargeHelpText: '余额充值自定义文案',
        balanceRechargeHelpTextPlaceholder: '仅显示在用户余额充值界面，留空不显示',
