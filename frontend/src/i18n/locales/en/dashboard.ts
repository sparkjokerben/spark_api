export default {
  ...
  keys: {
	...
	quotaStickyMode: 'Quota-saving sticky routing',
	quotaStickyInherit: 'Inherit group default',
	quotaStickyEnabled: 'Enabled',
	quotaStickyDisabled: 'Disabled',
	quotaStickyHint: 'Keep a session on the same account when possible to improve cache reuse.',
	quotaStickyLocked: 'This group does not allow API key overrides.',
