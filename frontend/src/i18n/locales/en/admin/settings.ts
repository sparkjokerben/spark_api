export default {
    settings: {
      ...
      payment: {
        ...
        balanceRechargeExpression: 'Balance Credit Expression',
        subscriptionRechargeExpression: 'Subscription Payment Expression',
        rechargeExpressionHint: 'Supports numbers, parentheses, and arithmetic; %fx_rate% is the live USD/CNY rate',
        fxRateFallback: 'FX Rate Fallback',
        fxRateFallbackHint: 'Value used for %fx_rate% when the live rate cannot be fetched',
        subscriptionDisplay: 'User Plan Information',
        subscriptionShowRate: 'Base rate',
        subscriptionShowPeakRate: 'Peak rate',
        subscriptionShow5hLimit: '5-hour limit',
        subscriptionShowWeekLimit: 'Weekly limit',
        subscriptionShowTotalLimit: 'Monthly limit',
        subscriptionShowModelScopes: 'Supported models',
        balanceRechargeHelpText: 'Balance Recharge Custom Text',
        balanceRechargeHelpTextPlaceholder: 'Shown only on the user balance recharge screen; leave blank to hide',
