...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/spark-work-space/spark_api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="spark-work-space/spark_api"
...
Documentation=https://github.com/spark-work-space/spark_api
